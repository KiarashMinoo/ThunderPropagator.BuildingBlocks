...
- **Modular Design**: The `RapidStreamer.BuildingBlocks.Modules` project provides a modular architecture for extensibility.
...
For `RapidStreamer.BuildingBlocks`:
```bash
dotnet add package RapidStreamer.BuildingBlocks
```

For `RapidStreamer.BuildingBlocks.Modules`:
```bash
dotnet add package RapidStreamer.BuildingBlocks.Modules
```

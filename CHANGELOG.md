...
| System.IdentityModel.Tokens.Jwt | 8.22.0 | 8.23.0 |

- Bump the testing group with 1 update `(b693e56)` — dependabot[bot]
- Bump System.IdentityModel.Tokens.Jwt from 8.22.0 to 8.23.0 `(fbc06e7)` — dependabot[bot]

## [1.0.1-beta.135] — 2026-09-14

### ⚙️ CI / Tooling

- ThunderPropagator.BuildingBlocks: grant actions:write for queue-mode artifact cleanup `(05e631e)` — Kiarash Minoo
...
- ThunderPropagator.BuildingBlocks: enable nuget-filter in OIDC publish step `(6731609)` — Kiarash Minoo

## [1.0.1-beta.127] — 2026-09-03

### 📦 Dependencies

| Package | Old | New |
|---------|-----|-----|
| System.IdentityModel.Tokens.Jwt | 8.21.0 | 8.22.0 |
| Microsoft.NET.Test.Sdk | 18.8.1 | 18.9.0 |
| NSubstitute | 6.0.0 | 6.2.0 |
| xunit.runner.visualstudio | 3.1.5 | 4.0.0 |

- Bump System.IdentityModel.Tokens.Jwt from 8.21.0 to 8.22.0 `(252a763)` — dependabot[bot]
- Bump the testing group with 3 updates `(892c72f)` — dependabot[bot]
...
- correct README.md file path in Directory.Build.props for packaging `(1bdb272)` — Kiarash Minoo
...
- change internal methods to public for improved accessibility in serialization and encryption classes `(b27ce55)` — Kiarash Minoo
